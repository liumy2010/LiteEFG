...
class Environment:
    ...
    def set_value(self, player: int, node: GraphNode, values: list[list[float]]) -> None:
        ...
    @typing.overload
    def set_value(self, player: int, node: GraphNode, values: list[float]) -> None:
        ...
    @typing.overload
...
class forward(GraphNodeStatus):
    ...
    def __init__(self, is_static: bool = False, color: int = 0) -> None:
        ...
def _exponential(node: GraphNode, lambda_: float = 1.0) -> GraphNode:
    ...
def _normal(node: GraphNode, mean: float = 0.0, stddev: float = 1.0) -> GraphNode:
    ...
def _uniform(node: GraphNode, lower: float = 0.0, upper: float = 1.0) -> GraphNode:
    ...
