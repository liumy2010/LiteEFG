...
- Q-Function based Regret Minimization (QFR) [[12]](#12)
- Regularized Dilated Optimistic Mirror Descent (Reg-DOMD) [[13]](#13)
- Regularized Counterfactual Regret Minimization (Reg-CFR) [[13]](#13)
- Implicit Exploration Online Mirror Descent (IXOMD) [[14]](#14)
- Balanced Online Mirror Descent (Balanced OMD) [[15]](#15)
- Balanced Follow the Regularized Leader (Balanced FTRL) [[16]](#16)
- Follow the Perturbed Leader (FTPL) [[17]](#17)
